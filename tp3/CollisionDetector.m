    ...
    methods(Static)
        ...
        function output = touchesCanSide(ballPos)
            output = (-Constants.CAN_HEIGHT/2 < ballPos(3) && ...
                ...
                Helper.distance(ballPos(1), ballPos(2), 0, 0) <= Constants.BALL_RADIUS + Constants.CAN_RADIUS;
        end
        
        function output = touchesCanTopFace(ballPos)
            output = ballPos(3) > 0 && ...
                Helper.distance(ballPos(1), ballPos(2), 0, 0) < Constants.CAN_RADIUS && ...
        ...
        function output = touchesCanTopCorner(ballPos)
            ...
            output = ballPos(3) > 0 && ...
                ...
                Constants.CAN_RADIUS <= Helper.distance(ballPos(1), ballPos(2), 0, 0) && ...
                Helper.distance(ballPos(1), ballPos(2), 0, 0) <= Constants.CAN_RADIUS + rho;
        end
        ...
        function output = touchesCanBottomCorner(ballPos)
            ...
            output = ballPos(3) < 0 && ... 
                (-Constants.CAN_HEIGHT/2 - Constants.BALL_RADIUS <= ballPos(3) && ...
                ballPos(3) <= -Constants.CAN_HEIGHT/2) && ... 
                Constants.BALL_RADIUS <= Helper.distance(ballPos(1), ballPos(2), 0, 0) && ...
                Helper.distance(ballPos(1), ballPos(2), 0, 0) <= Constants.CAN_RADIUS + rho;
        end
